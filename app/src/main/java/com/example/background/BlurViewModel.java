...
public class BlurViewModel extends AndroidViewModel {
  ...
  void applyBlur(int blurLevel) {
    WorkContinuation continuation = mWorkManager
        .beginUniqueWork(Constants.IMAGE_MANIPULATION_WORK_NAME, ExistingWorkPolicy.REPLACE,
    ...
    OneTimeWorkRequest saveImageRequest = new OneTimeWorkRequest.Builder(
        SaveImageToFileWorker.class)
  ...
  void setOutputUri(final String mOutputUri) {
